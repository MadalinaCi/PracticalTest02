...
public class PracticalTest02MainActivity extends AppCompatActivity {
   ...
   // private GetWeatherForecastButtonClickListener getWeatherForecastButtonClickListener = new GetWeatherForecastButtonClickListener();
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            /*if (city == null || city.isEmpty()) {
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameters from client (input) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //clientAddressEditText = (EditText) findViewById(R.id.city_edit_text);
